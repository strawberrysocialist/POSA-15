...
public class PlayPingPong implements Runnable {
    ...
    class PingPongThread extends HandlerThread implements Handler.Callback {
        ...
        protected void onLooperPrepared() {
            ...
            handlers[mMyType.ordinal()] = mHandler;
            ...
            if(mMyType == PingPong.PING) {
                ...
                msg.obj = handlers[PingPong.PONG.ordinal()];
        ...
        public boolean handleMessage(Message reqMsg) {
            ...
            // the reply.
            // @@ TODO - you fill in here.
            Message rspMsg = ((Handler)reqMsg.obj).obtainMessage();
            rspMsg.obj = reqMsg.getTarget();

            // Return control to the Handler in the other
            // HandlerThread, which is the "target" of the msg
            // parameter.
            // @@ TODO - you fill in here.
            ((Handler)reqMsg.obj).sendMessage(rspMsg);
    ...
    public void run() {
        ...
        // @@ TODO - you fill in here.
        HandlerThread pongThread = new PingPongThread(PingPong.PONG);
        HandlerThread pingThread = new PingPongThread(PingPong.PING);
