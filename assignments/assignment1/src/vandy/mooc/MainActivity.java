    ...
    protected void onActivityResult(int requestCode,
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            if (requestCode == DOWNLOAD_IMAGE_REQUEST) {
                ...
                // file.
                // @@ TODO -- you fill in here.
                Uri url = data.getParcelableExtra("url");
                if (url == null) {
                    Toast.makeText(this, "Failed to download image", Toast.LENGTH_LONG).show();
                    return;
                }
                Log.d(TAG,
                        "got downloaded image " + url.getPath());
                Intent intent = makeGalleryIntent(url.getPath());
        ...
        // code.
            ...
            Toast.makeText(this, "Customized result " + resultCode, Toast.LENGTH_LONG).show();
        }
    }
